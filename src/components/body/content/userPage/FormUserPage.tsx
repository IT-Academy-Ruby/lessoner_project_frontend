...
import {CODE, DEFAULT_COUNTRY_CODE, PASSWORD} from "../../../../constants";
import {CodeRegex, emailInvalidationRules, passwordRegex} from "../../../../validationRules";
import {
  Field, Form, Formik,
} from "formik";
...
const FormUserPage = ({component, isVisible, setIsVisible}: FormProps) => {
  ...
  return (
    <div className={classNames("wrapper-form-user-page", {"inVisible": !isVisible})}>
      <NameForm userName={user.name} handleClose={handleClose}/>
      <Formik
        ...
        onSubmit={(values) => {
          const items = {
            name: user.name,
            object: {component: values.birthday}
          };
          console.log(items)
