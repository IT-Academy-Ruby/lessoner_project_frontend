...
import NoLessonsdark from "../icons/noLessons-dark.svg";
import NoLessonslight from "../icons/noLessons-light.svg";
...
const NoLessonsPage: FC<noLessonsPageProps> = (props) => {
  const intl = useIntl();
