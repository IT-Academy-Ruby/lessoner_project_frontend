...
export const messages_en = {
  ...
  "app.email.error": "Please enter a valid email address",
  ...
  "app.firstRegistrationForm.passwordRegEx": `An invalid character is present in the password. Password must be between ${PASSWORD.mimaxLength} and ${PASSWORD.maxLength} characters; upper or lower case Latin letters (a–z, A–Z); numbers from 0 to 9; symbols ${PASSWORD.symbols}`,
  "app.firstRegistrationForm.passwordLength": `Password must be between ${PASSWORD.minLength} and ${PASSWORD.maxLength} characters`,
