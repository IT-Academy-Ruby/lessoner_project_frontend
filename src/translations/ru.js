...
export const messages_ru = { 
  ...
  "app.about.whatIsTheLessoner": "Что такое The Lessoner?",
  ...
  "app.about.aboutUs": "О нас",
  "app.about.aboutUsDescription": "The lessoner - это о людях, которые сделали это возможным. Мы не боялись задавать вопросы и чувствовали поддержку друг друга на каждом этапе создания этого проекта. Каждый аспект командной работы сделал этот опыт таким удивительным путешествием",
  ...
  "app.nameCategory.Finance": "Finance",
