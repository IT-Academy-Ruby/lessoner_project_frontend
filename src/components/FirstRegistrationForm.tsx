  ...
  const validate = async (values: FormValues) => {
    ...
    if (!passwordRegex.test(values.password)) {
      errors.password = `An invalid character is present in the password. Password must be between
       ${minSymbol} and ${maxSymbol} 
       characters; upper or lower case Latin letters (a–z, A–Z);
          ...
          return (
            <Form className="First-Registration-Form">
              ...
              <Field name='confirmPassword' component={PasswordAndConfirm}
                minSymbol={minSymbol} maxSymbol={maxSymbol} isConfirm={true} 
                error={touched.confirmPassword ? errors.confirmPassword : undefined} />
              <Field name='hasTermsAndConditions' component={Checkbox}
