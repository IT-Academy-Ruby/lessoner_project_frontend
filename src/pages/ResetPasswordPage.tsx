...
const ResetPasswordPage = () => {
  ...
  const checkEmail = (isSubmitting: boolean = false) => {
  ...
  const form =
    <Fragment>
      ...
      <h6>Enter the email that you used when register to recover your password. You will receive a password reset link</h6>
