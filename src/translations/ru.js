...
export const messages_ru = {
  ...
  "app.categories.uploadCategoryImageDescription": "Изображение должно отображать содержимое категории",
  "app.categories.uploadedFileCategoryImage": "Загруженный файл",
  "app.categories.uploadingFileCategoryImage": "Загрузка файла",
  "app.categories.button.change": "Изменить",
  "app.categories.button.delete": "Удалить",
  "app.categories.button.upload": "Загрузить изображение",
