...
export const messages_ru = { 
  ...
  "app.passwordAndConfirm.NewConfirmPass": "Подтвердите новый пароль",
  "app.passwordAndConfirm.NewPass": "Новый пароль",
  ...
  "app.YourselfPage.errorSmallName":
    "Имя пользователя должно содержать не менее {minSymbol} символов",
  "app.YourselfPage.errorBigName":
    "Имя пользователя не должно содержать более {maxSymbol} символов.",
  ...
  "app.userPage.avatarInformation": "Эта фотография представляет тебя в  «The Lessoner». Она отображается в вашем профиле и рядом с вашими комментариями. Фотография должна быть в формате JPG, PNG, максимальный размер файла 5 Мб",
  ...
  "app.add.lesson.edit.successful": "Ваш урок был успешно изменен",
};
